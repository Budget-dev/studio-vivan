...
export const VideoSection: React.FC = () => {
  ...
  return (
    <section className="py-12 md:py-24 bg-[#EBF5EE]">
      <div className="max-w-[1400px] mx-auto px-5 md:px-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
          {[...Array(4)].map((_, i) => (
            <div 
              key={i} 
              className="relative aspect-[9/16] rounded-xl md:rounded-[32px] overflow-hidden shadow-lg border-2 md:border-4 border-white group"
            >
              <video
                src={videoUrl}
