 ...
 * Replicates the provided design logic using Tailwind CSS.
 */
export const WhatsAppButton: React.FC = () => {
  // Official WhatsApp number for Vivaan Farms
  const phoneNumber = "919876543210"; 
  const message = "Hi Vivaan Farms, I'd like to inquire about your pure A2 Ghee and other products.";
  ...
  return (
    ...
    >
      <div className="w-full h-[45px] flex items-center justify-center transition-all duration-300 group-hover:w-[30%] group-hover:pl-2.5 shrink-0">
        <svg className="w-[25px] h-[25px] fill-white" viewBox="0 0 16 16">
      ...
      <div className="absolute right-0 w-0 opacity-0 text-white text-base font-bold transition-all duration-300 whitespace-nowrap group-hover:opacity-100 group-hover:w-[70%] group-hover:pr-4">
        Whatsapp
      </div>
    </a>
  );
