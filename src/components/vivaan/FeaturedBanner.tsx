        ...
        <div className="p-10 md:p-20 flex flex-col md:grid md:grid-cols-2 gap-16 items-center relative z-10">
          <div>
            ...
            <div className="flex items-center gap-6 flex-wrap">
              <Button 
                onClick={onCta}
                className="h-14 px-8 rounded-full bg-white text-primary font-black uppercase tracking-widest shadow-xl hover:translate-y-[-2px] transition-all"
              >
                Shop Combos →
              </Button>
              <div className="font-headline text-3xl font-extrabold text-white">Save 19%</div>
            </div>
          </div>
