...
const customerProductData = [
  ...
  { name: 'Rahul', city: 'Pune', product: 'Buffalo Ghee 5L' },
  { name: 'Kavya', city: 'Chennai', product: 'Coconut Oil 1L' },
  { name: 'Deepa', city: 'Hyderabad', product: 'A2 Gir Ghee 500ml' },
  { name: 'Ananya', city: 'Kolkata', product: 'Organic Honey 250g' },
  { name: 'Sameer', city: 'Ahmedabad', product: 'Cold Pressed Groundnut Oil 1L' },
  { name: 'Ishita', city: 'Jaipur', product: 'A2 Gir Ghee 500ml Glass Jar' },
  { name: 'Vikram', city: 'Surat', product: 'Spice Mix Combo Pack' },
  { name: 'Fatima', city: 'Lucknow', product: 'A2 Gir Ghee 1L' },
  { name: 'Rajesh', city: 'Patna', product: 'Desi Cow Ghee 500ml' },
  { name: 'Shalini', city: 'Indore', product: 'Almond Oil 500ml' },
  { name: 'Gaurav', city: 'Bhopal', product: 'Mixed Dry Fruits Pack' },
