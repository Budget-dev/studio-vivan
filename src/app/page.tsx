    ...
    <>
      ...
      >
        <main>
          ...
          <div className="space-y-16 md:space-y-28 py-16 md:py-28 bg-[#FDFBFA]">
            {/* A2 Ghee Peek Section */}
            {gheeProducts.length > 0 && (
              <section className="max-w-[1400px] mx-auto">
                <div className="px-5 md:px-10 flex items-end justify-between mb-8 md:mb-12 gap-4">
                ...
                <div className="flex overflow-x-auto no-scrollbar snap-x snap-mandatory gap-4 px-5 md:grid md:grid-cols-4 md:px-10 md:gap-8">
                  {gheeProducts.map((p) => (
                ...
                <div className="mt-8 md:mt-12 px-5 md:px-10 flex items-center justify-between">
                  <div className="flex-1 max-w-[140px] md:max-w-xs h-1 bg-[#F9F6EF] rounded-full overflow-hidden">
                    <div className="h-full w-1/3 bg-primary rounded-full shadow-[0_0_8px_rgba(27,94,59,0.2)]"></div>
                  </div>
                  <button 
                    onClick={() => handleCategoryFilter('ghee')}
                    className="h-10 md:h-12 px-6 md:px-8 rounded-full border-2 border-[#100C06]/5 hover:border-primary/20 text-[#100C06] font-black uppercase tracking-widest text-[9px] md:text-[11px] flex items-center gap-2 group transition-all"
                  >
              ...
              <section className="max-w-[1400px] mx-auto">
                ...
                <div className="mt-8 md:mt-12 px-5 md:px-10 flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className="h-10 md:h-12 px-6 md:px-8 rounded-full border-2 border-[#100C06]/5 hover:border-secondary/20 text-[#100C06] font-black uppercase tracking-widest text-[9px] md:text-[11px] flex items-center gap-2 group transition-all"
                  >
                    See All <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform" />
                  </button>
                </div>
